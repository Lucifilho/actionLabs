<?php
/**
 * Logo, navigation, and social links components with black background block pattern
 */
return array(
	'title'      => __( 'Logo, navigation, and social links components with background', 'twentytwentytwo' ),
