<?php
/**
 * Centered components with navigation, social links, and salmon background block pattern
 */
return array(
	'title'      => __( 'Centered components with navigation, social links, and background', 'twentytwentytwo' ),
	'categories' => array( 'components' ),
	'blockTypes' => array( 'core/template-part/components' ),
