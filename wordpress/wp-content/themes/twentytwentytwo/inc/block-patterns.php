...
function twentytwentytwo_register_block_patterns() {
	$block_pattern_categories = array(
		...
		'components'   => array( 'label' => __( 'Headers', 'twentytwentytwo' ) ),
	...
	$block_patterns = array(
		...
		'general-video-components-details',
		'general-list-events',
		...
		'components-default',
		'components-large-dark',
		'components-small-dark',
		'components-image-background',
		'components-image-background-overlay',
		'components-with-tagline',
		'components-text-only-green-background',
		'components-text-only-salmon-background',
		'components-title-and-button',
		'components-text-only-with-tagline-black-background',
		'components-logo-navigation-gray-background',
		'components-logo-navigation-social-black-background',
		'components-title-navigation-social',
		'components-logo-navigation-offset-tagline',
		'components-stacked',
		'components-centered-logo',
		'components-centered-logo-black-background',
		'components-centered-title-navigation-social',
		'components-title-and-button',
		'hidden-404',
		'hidden-bird',
